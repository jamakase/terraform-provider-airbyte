...
func (r ApiGetOpenApiSpecRequest) Execute() (*os.File, *_nethttp.Response, error) {
...
*/
func (a *OpenapiApiService) GetOpenApiSpec(ctx _context.Context) ApiGetOpenApiSpecRequest {
	return ApiGetOpenApiSpecRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
//  @return *os.File
func (a *OpenapiApiService) GetOpenApiSpecExecute(r ApiGetOpenApiSpecRequest) (*os.File, *_nethttp.Response, error) {
	var (
