...
func (r ApiTryNotificationConfigRequest) Execute() (NotificationRead, *_nethttp.Response, error) {
...
*/
func (a *NotificationsApiService) TryNotificationConfig(ctx _context.Context) ApiTryNotificationConfigRequest {
	return ApiTryNotificationConfigRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
func (a *NotificationsApiService) TryNotificationConfigExecute(r ApiTryNotificationConfigRequest) (NotificationRead, *_nethttp.Response, error) {
	var (
