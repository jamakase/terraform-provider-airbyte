...
func (r ApiGetLogsRequest) Execute() (*os.File, *_nethttp.Response, error) {
...
*/
func (a *LogsApiService) GetLogs(ctx _context.Context) ApiGetLogsRequest {
	return ApiGetLogsRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
//  @return *os.File
func (a *LogsApiService) GetLogsExecute(r ApiGetLogsRequest) (*os.File, *_nethttp.Response, error) {
	var (
