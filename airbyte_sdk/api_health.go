...
func (r ApiGetHealthCheckRequest) Execute() (HealthCheckRead, *_nethttp.Response, error) {
...
*/
func (a *HealthApiService) GetHealthCheck(ctx _context.Context) ApiGetHealthCheckRequest {
	return ApiGetHealthCheckRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
func (a *HealthApiService) GetHealthCheckExecute(r ApiGetHealthCheckRequest) (HealthCheckRead, *_nethttp.Response, error) {
	var (
